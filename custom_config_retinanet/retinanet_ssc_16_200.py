...
data_root = 'data/ForestDamages/active_learning_retinanet_ssc'
...
active_learning = dict(
    data_root='data/ForestDamages/active_learning_retinanet_ssc',
    ann_file='data/ForestDamages/active_learning_retinanet_ssc/annotations/instances_unlabeled.json',
    data_prefix=dict(img='data/ForestDamages/active_learning_retinanet_ssc/images_unlabeled'),
    # 训练池的SSC计算配置
    train_pool_cfg = dict(
        data_root='data/ForestDamages/active_learning_retinanet_ssc',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_retinanet_ssc/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(
            img=
            'data/ForestDamages/active_learning_retinanet_ssc/images_labeled_train'
        ),
        data_root='data/ForestDamages/active_learning_retinanet_ssc',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_retinanet_ssc/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(
            img=
            'data/ForestDamages/active_learning_retinanet_ssc/images_labeled_val'
        ),
        data_root='data/ForestDamages/active_learning_retinanet_ssc',
        metainfo=dict(
            classes=(
...
work_dir = 'work_dirs/retinanet_ssc_16_200/round_1'
