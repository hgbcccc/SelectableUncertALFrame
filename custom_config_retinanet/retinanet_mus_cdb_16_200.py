...
data_root = 'data/ForestDamages/active_learning_retinanet_mus_cdb'
...
active_learning = dict(
    data_root='data/ForestDamages/active_learning_retinanet_mus_cdb',
    ann_file='data/ForestDamages/active_learning_retinanet_mus_cdb/annotations/instances_unlabeled.json',
    data_prefix=dict(img='data/ForestDamages/active_learning_retinanet_mus_cdb/images_unlabeled'),
    # 训练池的SSC计算配置   
    train_pool_cfg = dict(
        data_root='data/ForestDamages/active_learning_retinanet_mus_cdb',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_retinanet_mus_cdb/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(
            img=
            'data/ForestDamages/active_learning_retinanet_mus_cdb/images_labeled_train'
        ),
        data_root='data/ForestDamages/active_learning_retinanet_mus_cdb',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_retinanet_mus_cdb/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(
            img=
            'data/ForestDamages/active_learning_retinanet_mus_cdb/images_labeled_val'
        ),
        data_root='data/ForestDamages/active_learning_retinanet_mus_cdb',
        metainfo=dict(
            classes=(   
...
work_dir = 'work_dirs/retinanet_mus_cdb_16_200'
