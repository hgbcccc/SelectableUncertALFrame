...
active_learning = dict(
    data_root='data/ForestDamages/active_learning_rl_wasserstein',
    ann_file='data/ForestDamages/active_learning_rl_wasserstein/annotations/instances_unlabeled.json',
    data_prefix=dict(img='data/ForestDamages/active_learning_rl_wasserstein/images_unlabeled'),
    # 训练池的SSC计算配置
    train_pool_cfg = dict(
        data_root='data/ForestDamages/active_learning_rl_wasserstein',
    ...
    sample_selection=dict(
        ...
        sample_selector="RL" , # 'Wasserstein' 或 'RL' 还有默认的ssc_score最大值排序选择
        rl_metric='wasserstein' # 强化学习中的度量方法可选: 'wasserstein', 'kl', 'js', 'euclidean', 'simple_stats', 'percentile', 'ensemble'
    )
)
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_rl_wasserstein/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_rl_wasserstein/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_rl_wasserstein',
...
val_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_rl_wasserstein/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_rl_wasserstein/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_rl_wasserstein',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
