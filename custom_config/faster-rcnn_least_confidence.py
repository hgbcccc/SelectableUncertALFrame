...
active_learning = dict(
    data_root='data/ForestDamages/active_learning_least_confidence',
    ann_file='data/ForestDamages/active_learning_least_confidence/annotations/instances_unlabeled.json',
    data_prefix=dict(img='data/ForestDamages/active_learning_least_confidence/images_unlabeled'),
    # 训练池的SSC计算配置   
    train_pool_cfg = dict(
        data_root='data/ForestDamages/active_learning_least_confidence',
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_least_confidence/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_least_confidence/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_least_confidence',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_least_confidence/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_least_confidence/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_least_confidence',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
...
work_dir = 'work_dirs/faster-rcnn_least_confidence_16_200'  # 修改工作目录