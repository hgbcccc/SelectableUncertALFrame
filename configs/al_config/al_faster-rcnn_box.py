active_learning = dict(
    data_root='data/ForestDamages/active_learning_box',
    inference_options=dict(
        save_results=True,
        score_thr=0.01,
        uncertainty_methods=['box'],
        selected_metric="center_variance"

    ),
    max_iterations=16,
    sample_selection=dict(
        num_samples=100,
        uncertainty_metric='center_variance'  # 可选: box_uncertainty, box_score, box_iou, box_stability
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_box/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_box/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_box',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_box/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_box/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_box',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
