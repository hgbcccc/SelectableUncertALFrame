...
active_learning = dict(
    ...
    ann_file='data/ForestDamages/active_learning_ssc/annotations/instances_unlabeled.json',
    data_prefix=dict(img='data/ForestDamages/active_learning_ssc/images_unlabeled'),
    # 训练池的SSC计算配置
    train_pool_cfg = dict(
        data_root='data/ForestDamages/active_learning_ssc',
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_ssc/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_ssc/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_ssc',
...
val_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_ssc/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_ssc/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_ssc',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
