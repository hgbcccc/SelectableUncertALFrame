active_learning = dict(
    data_root='data/ForestDamages/active_learning_4',
    inference_options=dict(
        save_results=True,
        score_thr=0.01,
        uncertainty_methods=['margin'],
        selected_metric="normalized_margin"
    ),
    max_iterations=16,
    sample_selection=dict(
        num_samples=100,
        uncertainty_metric='normalized_margin'  # 可选: margin, normalized_margin
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_4/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_4/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_4',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_4/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_4/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_4',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
