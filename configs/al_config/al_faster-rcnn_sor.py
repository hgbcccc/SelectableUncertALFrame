active_learning = dict(
    data_root='data/ForestDamages/active_learning_1',
    ...
    sample_selection=dict(
        num_samples=100,
        uncertainty_metric='sum_sor'  # 可选: max_sor, avg_sor, sum_sor
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_1/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_1/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_1',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_1/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_1/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_1',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
