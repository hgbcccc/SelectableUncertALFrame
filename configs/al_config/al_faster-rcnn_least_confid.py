active_learning = dict(
    data_root='data/ForestDamages/active_learning_2',
    inference_options=dict(
        save_results=True,
        score_thr=0.01,
        uncertainty_methods=['least_confident'],
        selected_metric="least_confident"

    ),
    max_iterations=16,
    sample_selection=dict(
        num_samples=100,
        uncertainty_metric='least_confident'  # 可选: least_confident, avg_least_confident
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_2/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_2/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_2',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_2/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_2/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_2',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
