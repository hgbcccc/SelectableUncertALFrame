active_learning = dict(
    data_root='data/ForestDamages/active_learning_density',
    inference_options=dict(
        save_results=True,
        score_thr=0.01,
        uncertainty_methods=['density'],
        selected_metric="uncertainty_density"

    ),
    max_iterations=16,
    sample_selection=dict(
        num_samples=100,
       uncertainty_metric='uncertainty_density'  # 可选: uncertainty_density, high_uncertainty_ratio
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_density/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_density/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_density',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_density/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_density/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_density',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
