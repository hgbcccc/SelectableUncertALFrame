active_learning = dict(
    data_root='data/ForestDamages/active_learning',
    inference_options=dict(
        save_results=True,
        score_thr=0.01,
        uncertainty_methods=['value'],
        selected_metric="total_value_score"
    ...
    sample_selection=dict(
        num_samples=100,
        strategy='max',
        uncertainty_metric='total_value_score'  # 可选: difficulty_score, information_score, diversity_score, total_value_score
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning/images_labeled_train'),
        data_root='data/ForestDamages/active_learning',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning/images_labeled_val'),
        data_root='data/ForestDamages/active_learning',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
