active_learning = dict(
    data_root='data/ForestDamages/active_learning_coreset',
    ...
    sample_selection=dict(
        num_samples=100, uncertainty_metric='coreset',
        coreset_options=dict(
                backbone='resnet50',
                pretrained=True,
                feature_layer='layer4',
                img_size=(512, 512),  # 需与模型输入尺寸一致 # 缓存目录
...
interval = 1
load_from = 'work_dirs\\faster-rcnn\\al_density\\round_2\\epoch_1.pth'
log_level = 'INFO'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_coreset/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(
            img='data/ForestDamages/active_learning_coreset/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_coreset',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'data/ForestDamages/active_learning_coreset/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(
            img='data/ForestDamages/active_learning_coreset/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_coreset',
        metainfo=dict(
            classes=(
                'Aspen',
...
work_dir = 'work_dirs\\faster-rcnn\\al_density\\round_3'
