active_learning = dict(
    data_root='data/ForestDamages/active_learning_n',
    ...
    sample_selection=dict(
        num_samples=100,
        uncertainty_metric='normalized_entropy'  # 可选: entropy, normalized_entropy
    ))
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
    ann_file='data/ForestDamages/active_learning_n/annotations/instances_labeled_train.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_n/images_labeled_train'),
        data_root='data/ForestDamages/active_learning_n',
...
val_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='data/ForestDamages/active_learning_n/annotations/instances_labeled_val.json',
        backend_args=None,
        data_prefix=dict(img='data/ForestDamages/active_learning_n/images_labeled_val'),
        data_root='data/ForestDamages/active_learning_n',
        metainfo=metainfo,
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
